...
var ArmorListComponent = (function () {
    ...
    ArmorListComponent.prototype.armorCoverageList = function (armor) {
        var props = [];
        for (var prop in armor) {
            if (__WEBPACK_IMPORTED_MODULE_2__shared_armor_data__["a" /* ArmorLocationCodes */][prop] && armor[prop]) {
                props.push(__WEBPACK_IMPORTED_MODULE_2__shared_armor_data__["a" /* ArmorLocationCodes */][prop]);
            }
        }
        return props.join(', ');
    };
...
var ProtectionTableComponent = (function () {
    function ProtectionTableComponent() {
        this.locationLabels = __WEBPACK_IMPORTED_MODULE_1__shared_armor_data__["b" /* ArmorLocationLabels */];
    }
    ProtectionTableComponent.prototype.ngOnInit = function () {
        this.parseLocationList();
        this.damageTypes = __WEBPACK_IMPORTED_MODULE_1__shared_armor_data__["d" /* DamageTypes */];
    };
    ...
    ProtectionTableComponent.prototype.parseLocationList = function () {
        var locations = [];
        for (var location_1 in __WEBPACK_IMPORTED_MODULE_1__shared_armor_data__["b" /* ArmorLocationLabels */]) {
            if (location_1) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ArmorTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return DamageTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ProtectionValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ArmorLocationLabels; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArmorLocationCodes; });
var ArmorTypes = [
    'cloth',
    'quilt',
    'leather',
...
var ArmorPiece = (function () {
    ...
    ArmorPiece.prototype.protection = function (aspect) {
        var base = __WEBPACK_IMPORTED_MODULE_0__armor_data__["e" /* ProtectionValue */][this.type][aspect];
