...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__manors_manors_module__ = __webpack_require__("../../../../../src/app/manors/manors.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__travel_travel_module__ = __webpack_require__("../../../../../src/app/travel/travel.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__names_names_module__ = __webpack_require__("../../../../../src/app/names/names.module.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__manors_manors_module__["a" /* ManorsModule */],
                __WEBPACK_IMPORTED_MODULE_6__travel_travel_module__["a" /* TravelModule */],
                __WEBPACK_IMPORTED_MODULE_7__names_names_module__["a" /* NamesModule */],
    ...
    FiefBudgetComponent.prototype.createForm = function () {
        this.budgetForm = this.fb.group({
            woodsWorked: [0, [
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0),
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(this.manor.woodlandAcres)
                ]],
            cropSeed: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            winterFeed: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            fiefMaintenance: [0, [
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required,
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0),
                    __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(this.manor.clearedAcres)
                ]],
            assart: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(this.manor.woodlandAcres)]]
        });
    };
...
var GeneralDataComponent = (function () {
    ...
    GeneralDataComponent.prototype.createForm = function () {
        this.generalDataForm = this.fb.group({
            year: [null],
            topology: [null, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required],
            grossAcres: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            woodlandAcres: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0), __WEBPACK_IMPORTED_MODULE_5__shared_utilities__["d" /* maxGrossAcres */]]],
            clearedAcres: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0), __WEBPACK_IMPORTED_MODULE_5__shared_utilities__["d" /* maxGrossAcres */]]],
            landQuality: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0.75), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(1.3)]],
            fiefIndex: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0.75), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(1.25)]],
            tradeIndex: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0.5), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(1.7)]],
            weatherIndex: [0, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0.65), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(1.35)])]
        });
    };
    /**
...
var LordsBudgetComponent = (function () {
    ...
    LordsBudgetComponent.prototype.createForm = function () {
        this.lordsBudgetForm = this.fb.group({
            taxes: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            amercements: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            feudalIncome: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            feudalPayments: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            tithe: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            laborHired: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            politicalExpenses: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]]
        });
    };
...
var PoliciesComponent = (function () {
    ...
    PoliciesComponent.prototype.createForm = function () {
        this.policiesForm = this.fb.group({
            baseRent: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(30), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(120)]],
            freeholderRent: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(3), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(12)]],
            serfLabor: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].max(8)]],
            foAcresPerHH: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            foAcresPerLF: [0, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required],
            isSlaveState: '',
            isBailiffRun: '',
        });
    };
...
module.exports = "<div class=\"container page\">\n  <h1>Random Harnic Names</h1>\n  <p>This is a simple name generator that pulls from lists medeival names listed in england ~1400-1600. I will\n    eventulaly expand this to include options for Ivinian, Jarin and other names but for now this should be suitable for\n    most feudal kingdom names.</p>\n  <div class=\"row\">\n    <div class=\"col-xs-10 col-sm-10 col-md-6 mt-1\">\n      <div class=\"btn-group\" role=\"group\" aria-label=\"Gender\">\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\"\n          [ngClass]=\"selectedGender === gender.FEMALE ? 'active btn-dark' : null\"\n                (click)=\"onGenderSelect(gender.FEMALE)\"\n        >Female</button>\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\"\n          [ngClass]=\"selectedGender === gender.MALE ? 'active btn-dark' : null\"\n                (click)=\"onGenderSelect(gender.MALE)\"\n        >Male</button>\n      </div>\n    </div>\n    <div class=\"col-xs-10 col-sm-10 col-md-6 mt-1\">\n      <div class=\"btn-group\" role=\"group\" aria-label=\"Culture\">\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\" (click)=\"onCultureSelect(culture.ENGLISH)\"\n                [ngClass]=\"selectedCulture === culture.ENGLISH ? 'active btn-dark' : null\">Feudal</button>\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\" (click)=\"onCultureSelect(culture.WELSH)\"\n                [ngClass]=\"selectedCulture === culture.WELSH ? 'active btn-dark' : null\">Jarin</button>\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\" (click)=\"onCultureSelect(culture.SAXON)\"\n                [ngClass]=\"selectedCulture === culture.SAXON ? 'active btn-dark' : null\">Pharic</button>\n        <button type=\"button\" class=\"btn btn-secondary btn-outline-dark\" (click)=\"onCultureSelect(culture.SCANDINAVIAN)\"\n                [ngClass]=\"selectedCulture === culture.SCANDINAVIAN ? 'active btn-dark' : null\">Ivinian</button>\n      </div>\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-xs-10 col-sm-10 col-md-6\">\n      <h6 class=\"mt-2\">Select Gender or Culture to Generate</h6>\n      <ul>\n        <li *ngFor=\"let name of generatedNames\">{{name}}</li>\n      </ul>\n      <app-loading-spinner *ngIf=\"showSpinner\" [msg]=\"'Loading names ...'\"></app-loading-spinner>\n    </div>\n    <div class=\"col-xs-10 col-sm-10 col-md-6\">\n      <ul>\n        <li><strong>Feudal:</strong> Includes most common harnic names among the main kingdoms of Harn and the Thardic Republic.  In this generator this includes lists of names and surnames derived from cencus in England between the 15th and 16th centry.</li>\n        <li><strong>Jarin:</strong> Includes the older tribal/clannish cultures on Harn.  Somtimes these names appear in the Feudal Kingdoms, particularly in families on the frontier.  These names are also common in Harnic Barbarian Jarin clans.  In this generator this draws from a list of Welsh and Celtic names from the mid to early middle ages.</li>\n        <li><strong>Pharic:</strong> Includes various barbarian groups of Pharic origin on Harn such as the Chelni, Gozyda, Hodiri, Kath, Pagaelin and Tulwyn.  In this generator this draws from a list of Saxon names from the early-mid middle ages.</li>\n        <li><strong>Ivanian:</strong> Includes anyone of Ivanian descent, includin the occupying clans in Orbaal.  In th is generator this includes list of Scandinavian names from the mid to late middle ages.</li>\n        <li><strong>Orbaleese (Not Implemented):</strong> Includes the Orbaleese Jarin people in northern Harn and some northern Harnic Barbarian clans.  In this generator this includes list of Scots and Celtic names.</li>\n      </ul>\n      <h5>Note on Surnames</h5>\n      <p>Cultures that return only a given name don't have a deep tradition of lasting family surnames.  This is common in most of the regions of Harn outside the main Feudal Kingdoms.  Instead they often use descriptive, bynames or generational names such as 'the Red Beard' or 'daugher/son of' but even these practices vary greatly between groups.  Some may use a clan name, others may have multiple descriptive names.  Often in the Feudal Kingdoms, outsiders are referred to by their ehtnic group such as 'Wulfgar the Ivinian' or 'Grogar the Hodiri'.</p>\n    </div>\n  </div>\n</div>\n"
...
var DistanceComponent = (function () {
    ...
    DistanceComponent.prototype.createForm = function () {
        this.distanceForm = this.fb.group({
            leagues: [5, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            hexes: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            miles: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]],
            km: [0, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(0)]]
        });
    };
