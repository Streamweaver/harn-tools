...
module.exports = "<div class=\"container-fluid page\">\n  <h2>Armor, because.... look out behind you!!!</h2>\n  <div class=\"row\">\n\n    <div class=\"col-md-4\">\n      <div class=\"card border border-dark\">\n        <div class=\"card-header bg-dark text-light\"><h5 class=\"card-title col-xs-8\">Available Armor</h5>\n        </div>\n        <div class=\"card-header text-center pb-1 pt-1\">\n          <div class=\"btn-group btn-group-sm\" role=\"group\" aria-label=\"First group\">\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor()\">All</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Cloth)\">Cloth</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Quilt)\">Quilt</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Leather)\">Leather</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Kurbul)\">Kurbul</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Ring)\">Ring</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Mail)\">Mail</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Scale)\">Scale</button>\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"filterArmor(armorType.Plate)\">Plate</button>\n          </div>\n        </div>\n        <div class=\"card-body\">\n\n          <div *ngFor=\"let item of armorList; let i = index\" class=\"list-group-item row\" dnd-draggable\n               [dragEnabled]=\"true\" [dragData]=\"item\" [dropZones]=\"['body']\">\n            <div class=\"d-flex w-100 justify-content-between\">\n              <h5 class=\"mb-1\">{{item.name | titlecase}}</h5>\n              <small>{{item.basePrice}}d/{{item.baseWeight}}lb</small>\n            </div>\n          </div>\n\n        </div>\n      </div>\n    </div>\n\n    <div class=\"col-md-4\">\n      <div class=\"card border border-dark fixed\">\n        <div class=\"card-header bg-dark\"><h5 class=\"card-title text-light\">Armor Worn</h5></div>\n        <div class=\"card-body\" dnd-droppable (onDropSuccess)=\"addWornArmor($event)\" [dropZones]=\"['body']\">\n          <div *ngIf=\"armorWorn < 1\">Drag and Drop armor here</div>\n          <div *ngFor=\"let item of armorWorn\" dnd-draggable [dragEnabled]=\"true\"\n               [dragData]=\"item\" [dropZones]=\"['trash']\">\n            <div class=\"list-group-item\">\n              <div class=\"d-flex\">\n                <h5 class=\"mr-auto p-1\">{{item.name | titlecase}}</h5>\n                <div class=\"p-1 pr-2\">{{item.price()}}d/{{item.baseWeight}}lb</div>\n                <div class=\"p-1 text-center\">Qlty:\n                  <a (click)=\"item.decreaseQuality()\"><i class=\"far fa-minus-square\"></i></a>\n                  {{item.quality}}\n                  <a (click)=\"item.increaseQuality()\"><i class=\"far fa-plus-square\"></i></a>\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"card-footer pb-3 pt-3\" dnd-droppable (onDropSuccess)=\"removeWornArmor($event)\"\n             [dropZones]=\"['trash']\">\n          <i class=\"fas fa-trash\"></i> Drop here to remove\n        </div>\n      </div>\n    </div>\n\n    <div class=\"col-md-4\">\n      <app-protection-table [armorWorn]=\"armorWorn\"></app-protection-table>\n    </div>\n\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__ = __webpack_require__("../../../../../src/app/armor/shared/armor.enum.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_armor_model__ = __webpack_require__("../../../../../src/app/armor/shared/armor.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_armor_data__ = __webpack_require__("../../../../../src/app/armor/shared/armor.data.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ArmorListComponent = (function () {
    function ArmorListComponent() {
        this.armorType = __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["d" /* ArmorType */];
    }
    ArmorListComponent.prototype.ngOnInit = function () {
        this.armorWorn = [];
        this.filterArmor();
    };
    ArmorListComponent.prototype.addWornArmor = function ($event) {
        var data = $event.dragData;
        this.armorWorn.push(new __WEBPACK_IMPORTED_MODULE_2__shared_armor_model__["a" /* ArmorPiece */](data.name, data.type, data.baseWeight, data.basePrice, data.coverage));
    };
    ArmorListComponent.prototype.removeWornArmor = function ($event) {
        var idx = this.armorWorn.indexOf($event.dragData);
        if (idx > -1) {
    ...
    ArmorListComponent.prototype.filterArmor = function (armorType) {
        ...
        if (armorType === null) {
            this.armorList = __WEBPACK_IMPORTED_MODULE_3__shared_armor_data__["a" /* ArmorList */];
        }
        else {
            this.armorList = __WEBPACK_IMPORTED_MODULE_3__shared_armor_data__["a" /* ArmorList */].filter(function (armor) { return armor.type === armorType; });
        }
    };
...
var ProtectionTableComponent = (function () {
    function ProtectionTableComponent() {
        this.protection = __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["c" /* ArmorProtection */];
        this.location = __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["a" /* ArmorLocation */];
        this.locationLabels = __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["b" /* ArmorLocationLabels */];
    }
    ...
    ProtectionTableComponent.prototype.locationList = function () {
        var locations = [];
        for (var location_1 in __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["a" /* ArmorLocation */]) {
            if (Number(location_1) >= 0) {
                locations.push(Number(location_1));
            }
        }
        return locations;
    };
    ProtectionTableComponent.prototype.protectionList = function () {
        var protectionTypes = [];
        for (var protectionType in __WEBPACK_IMPORTED_MODULE_1__shared_armor_enum__["c" /* ArmorProtection */]) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('armorWorn'),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ProtectionValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArmorList; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__armor_enum__ = __webpack_require__("../../../../../src/app/armor/shared/armor.enum.ts");

var ProtectionValue = (_a = {},
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Cloth] = (_b = {},
        _b[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 1,
        _b[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 1,
        _b[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 1,
        _b[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 1,
        _b),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Quilt] = (_c = {},
        _c[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 5,
        _c[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 3,
        _c[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 2,
        _c[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 4,
        _c),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Leather] = (_d = {},
        _d[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 2,
        _d[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 4,
        _d[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 3,
        _d[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 3,
        _d),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Kurbul] = (_e = {},
        _e[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 4,
        _e[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 5,
        _e[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 4,
        _e[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 3,
        _e),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Ring] = (_f = {},
        _f[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 3,
        _f[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 6,
        _f[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 4,
        _f[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 3,
        _f),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Mail] = (_g = {},
        _g[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 2,
        _g[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 8,
        _g[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 5,
        _g[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 1,
        _g),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Scale] = (_h = {},
        _h[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 5,
        _h[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 9,
        _h[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 4,
        _h[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 5,
        _h),
    _a[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Plate] = (_j = {},
        _j[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Blunt] = 6,
        _j[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Edge] = 10,
        _j[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Pierce] = 6,
        _j[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["c" /* ArmorProtection */].Fire] = 2,
        _j),
    _a);
var ArmorList = [
    {
        ...
        coverage: (_k = {},
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Skull] = true,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Knees] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Calves] = false,
            _k[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Feet] = false,
            _k), baseWeight: 0.4,
        basePrice: 8
    },
    {
        ...
        type: __WEBPACK_IMPORTED_MODULE_0__armor_enum__["d" /* ArmorType */].Cloth,
        coverage: (_l = {},
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Skull] = true,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = true,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Knees] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Calves] = false,
            _l[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Feet] = false,
            _l), baseWeight: 0.8,
        basePrice: 16
    },
    {
        ...
        coverage: (_m = {},
            ...
            _m[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _m[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _m[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
    ...
    },
    {
        ...
        coverage: (_p = {},
            ...
            _p[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = true,
            _p[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = true,
    ...
    },
    {
        ...
        coverage: (_q = {},
            ...
            _q[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = true,
            _q[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = true,
            _q[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = true,
    ...
    },
    {
        ...
        coverage: (_r = {},
            ...
            _r[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = true,
    ...
    },
    {
        ...
        coverage: (_t = {},
            ...
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _t[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_x = {},
            ...
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _x[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
    ...
    },
    {
        ...
        coverage: (_z = {},
            ...
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _z[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
    ...
    },
    {
        ...
        coverage: (_0 = {},
            ...
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Knees] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Calves] = false,
            _0[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Feet] = false,
            _0), baseWeight: 0.8,
        basePrice: 16
    },
    {
        ...
        coverage: (_1 = {},
            ...
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _1[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
    ...
    },
    {
        ...
        coverage: (_2 = {},
            ...
            _2[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _2[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _2[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
    ...
    },
    {
        ...
        coverage: (_3 = {},
            ...
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            ...
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _3[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
    ...
    },
    {
        ...
        coverage: (_7 = {},
            ...
            _7[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _7[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = true,
            _7[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
    ...
    },
    {
        ...
        coverage: (_9 = {},
            ...
            _9[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_10 = {},
            ...
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _10[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_11 = {},
            ...
            _11[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _11[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _11[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            _11[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
    ...
    },
    {
        ...
        coverage: (_12 = {},
            ...
            _12[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
            _12[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
    ...
    },
    {
        ...
        coverage: (_13 = {},
            ...
            _13[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            ...
            _13[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _13[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _13[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
    ...
    },
    {
        ...
        coverage: (_14 = {},
            ...
            _14[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _14[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _14[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _14[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _14[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
    ...
    },
    {
        ...
        coverage: (_15 = {},
            ...
            _15[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _15[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _15[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _15[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _15[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_17 = {},
            ...
            _17[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _17[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _17[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _17[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_18 = {},
            ...
            _18[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _18[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _18[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _18[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _18[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_19 = {},
            ...
            _19[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            ...
            _19[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = true,
    ...
    },
    {
        ...
        coverage: (_20 = {},
            ...
            _20[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _20[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _20[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
    ...
    },
    {
        ...
        coverage: (_22 = {},
            ...
            _22[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = true,
    ...
    },
    {
        ...
        coverage: (_23 = {},
            ...
            _23[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _23[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _23[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
    ...
    },
    {
        ...
        coverage: (_26 = {},
            ...
            _26[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _26[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _26[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _26[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_27 = {},
            ...
            _27[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = true,
    ...
    },
    {
        ...
        coverage: (_32 = {},
            ...
            _32[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_33 = {},
            ...
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _33[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_34 = {},
            ...
            _34[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_35 = {},
            ...
            _35[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Face] = false,
            _35[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Neck] = false,
            _35[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Shoulders] = false,
            _35[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].UpperArms] = false,
            _35[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
    ...
    },
    {
        ...
        coverage: (_36 = {},
            ...
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _36[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_37 = {},
            ...
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _37[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
    ...
    },
    {
        ...
        coverage: (_38 = {},
            ...
            _38[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _38[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _38[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _38[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _38[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
    ...
    },
    {
        ...
        coverage: (_39 = {},
            ...
            _39[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _39[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
            _39[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hips] = false,
            _39[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Groin] = false,
            _39[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Thighs] = false,
    ...
    },
    {
        ...
        coverage: (_40 = {},
            ...
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Elbows] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Forearms] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].Hands] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxFront] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].ThoraxBack] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenFront] = false,
            _40[__WEBPACK_IMPORTED_MODULE_0__armor_enum__["a" /* ArmorLocation */].AbdomenBack] = false,
...
/***/ "../../../../../src/app/armor/shared/armor.enum.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return ArmorType; });
/* unused harmony export ArmorTypeLabel */
/* unused harmony export ArmorLabelType */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ArmorLocation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ArmorLocationLabels; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ArmorProtection; });
var ArmorType;
(function (ArmorType) {
    ArmorType[ArmorType["Cloth"] = 0] = "Cloth";
    ArmorType[ArmorType["Quilt"] = 1] = "Quilt";
    ArmorType[ArmorType["Leather"] = 2] = "Leather";
    ArmorType[ArmorType["Kurbul"] = 3] = "Kurbul";
    ArmorType[ArmorType["Ring"] = 4] = "Ring";
    ArmorType[ArmorType["Mail"] = 5] = "Mail";
    ArmorType[ArmorType["Scale"] = 6] = "Scale";
    ArmorType[ArmorType["Plate"] = 7] = "Plate";
})(ArmorType || (ArmorType = {}));
var ArmorTypeLabel = (_a = {},
    _a[ArmorType.Cloth] = 'cloth',
    _a[ArmorType.Quilt] = 'quilt',
    _a[ArmorType.Leather] = 'leather',
    _a[ArmorType.Kurbul] = 'kurbul',
    _a[ArmorType.Ring] = 'Ring',
    _a[ArmorType.Mail] = 'mail',
    _a[ArmorType.Scale] = 'scale',
    _a[ArmorType.Plate] = 'plate',
    _a);
var ArmorLabelType = {
...
(function (ArmorLocation) {
    ArmorLocation[ArmorLocation["Skull"] = 0] = "Skull";
    ArmorLocation[ArmorLocation["Face"] = 1] = "Face";
    ArmorLocation[ArmorLocation["Neck"] = 2] = "Neck";
    ArmorLocation[ArmorLocation["Shoulders"] = 3] = "Shoulders";
    ArmorLocation[ArmorLocation["UpperArms"] = 4] = "UpperArms";
    ArmorLocation[ArmorLocation["Elbows"] = 5] = "Elbows";
    ArmorLocation[ArmorLocation["Forearms"] = 6] = "Forearms";
    ArmorLocation[ArmorLocation["Hands"] = 7] = "Hands";
    ArmorLocation[ArmorLocation["ThoraxFront"] = 8] = "ThoraxFront";
    ArmorLocation[ArmorLocation["ThoraxBack"] = 9] = "ThoraxBack";
    ArmorLocation[ArmorLocation["AbdomenFront"] = 10] = "AbdomenFront";
    ArmorLocation[ArmorLocation["AbdomenBack"] = 11] = "AbdomenBack";
    ArmorLocation[ArmorLocation["Hips"] = 12] = "Hips";
    ArmorLocation[ArmorLocation["Groin"] = 13] = "Groin";
    ArmorLocation[ArmorLocation["Thighs"] = 14] = "Thighs";
    ArmorLocation[ArmorLocation["Knees"] = 15] = "Knees";
    ArmorLocation[ArmorLocation["Calves"] = 16] = "Calves";
    ArmorLocation[ArmorLocation["Feet"] = 17] = "Feet";
})(ArmorLocation || (ArmorLocation = {}));
/**
 * This is a map of ArmorLocation to the field label in the object.
 * @type {string}
 */
var ArmorLocationLabels = (_b = {},
    _b[ArmorLocation.Skull] = 'skull',
    _b[ArmorLocation.Face] = 'face',
    _b[ArmorLocation.Neck] = 'neck',
    _b[ArmorLocation.Shoulders] = 'shoulders',
    _b[ArmorLocation.UpperArms] = 'upper arms',
    _b[ArmorLocation.Elbows] = 'elbows',
    _b[ArmorLocation.Forearms] = 'forearms',
    _b[ArmorLocation.Hands] = 'hands',
    _b[ArmorLocation.ThoraxFront] = 'thorax (front)',
    _b[ArmorLocation.ThoraxBack] = 'thorax (back)',
    _b[ArmorLocation.AbdomenFront] = 'abdomen (front)',
    _b[ArmorLocation.AbdomenBack] = 'abdomen (back)',
    _b[ArmorLocation.Hips] = 'hips',
    _b[ArmorLocation.Groin] = 'groin',
    _b[ArmorLocation.Thighs] = 'thighs',
    _b[ArmorLocation.Knees] = 'knees',
    _b[ArmorLocation.Calves] = 'calves',
    _b[ArmorLocation.Feet] = 'feet',
    _b);
var ArmorProtection;
(function (ArmorProtection) {
    ArmorProtection[ArmorProtection["Blunt"] = 0] = "Blunt";
    ArmorProtection[ArmorProtection["Edge"] = 1] = "Edge";
    ArmorProtection[ArmorProtection["Pierce"] = 2] = "Pierce";
    ArmorProtection[ArmorProtection["Fire"] = 3] = "Fire";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__armor_enum__ = __webpack_require__("../../../../../src/app/armor/shared/armor.enum.ts");


var ArmorPiece = (function () {
    function ArmorPiece(name, type, baseWeight, basePrice, coverage) {
        this.name = name;
        this.type = type;
    ...
    ArmorPiece.prototype.maxQuality = function () {
        return Math.max(__WEBPACK_IMPORTED_MODULE_0__armor_data__["b" /* ProtectionValue */][this.type][__WEBPACK_IMPORTED_MODULE_1__armor_enum__["c" /* ArmorProtection */].Blunt], __WEBPACK_IMPORTED_MODULE_0__armor_data__["b" /* ProtectionValue */][this.type][__WEBPACK_IMPORTED_MODULE_1__armor_enum__["c" /* ArmorProtection */].Edge], __WEBPACK_IMPORTED_MODULE_0__armor_data__["b" /* ProtectionValue */][this.type][__WEBPACK_IMPORTED_MODULE_1__armor_enum__["c" /* ArmorProtection */].Pierce], __WEBPACK_IMPORTED_MODULE_0__armor_data__["b" /* ProtectionValue */][this.type][__WEBPACK_IMPORTED_MODULE_1__armor_enum__["c" /* ArmorProtection */].Fire]);
    };
    ...
    ArmorPiece.prototype.protection = function (aspect) {
        var base = __WEBPACK_IMPORTED_MODULE_0__armor_data__["b" /* ProtectionValue */][this.type][aspect];
...
var CropListComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('manor'),
...
var FiefBudgetComponent = (function () {
    ...
    FiefBudgetComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__shared_services_shared_data_service__["a" /* SharedDataService */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormBuilder */]])
    ], FiefBudgetComponent);
...
var HouseholdMemberComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('member'),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('idx'),
...
var ManorComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_3__crop_list_crop_list_component__["a" /* CropListComponent */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_4__herd_list_herd_list_component__["a" /* HerdListComponent */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_20__tenant_list_tenant_list_component__["a" /* TenantListComponent */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_5__household_list_household_list_component__["a" /* HouseholdListComponent */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_9" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_6__lords_budget_lords_budget_component__["a" /* LordsBudgetComponent */]),
...
var PoliciesComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('policies'),
...
var TenantComponent = (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])('tenant'),
